...
*/
  ...
  #define PRI_INPUT1            1, 850, 0, 3970, 0      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            1, 850, 0, 3970, 0      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
...
//  #define DUAL_INPUTS                       // ADC*(Primary) + Sideboard_R(Auxiliary). Uncomment this to use Dual-inputs
  #define PRI_INPUT1              1,   850, 0, 3970, 0  // Pedal Brake        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2              1,   850, 0, 3970, 0  // Pedal Accel        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  ...
  #define MULTI_MODE_DRIVE                  // This option enables the selection of 3 driving modes at start-up using combinations of Brake and Throttle pedals (see below)
      ...
      #define MULTI_MODE_DRIVE_M1_MAX   700
      #define MULTI_MODE_DRIVE_M1_RATE  250
      #define MULTI_MODE_M1_I_MOT_MAX   5
      #define MULTI_MODE_M1_N_MOT_MAX   700

      // INTERMEDIATE MODE: Power ON + Brake [pressed] + Throttle [released]
      #define MULTI_MODE_DRIVE_M2_MAX   900
      #define MULTI_MODE_DRIVE_M2_RATE  375
      #define MULTI_MODE_M2_I_MOT_MAX   6
      #define MULTI_MODE_M2_N_MOT_MAX   900
      ...
      #define MULTI_MODE_M3_I_MOT_MAX   7
